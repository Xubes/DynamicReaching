...
public void createGUI(){
  ...
  csliderBrake = new GCustomSlider(this, 470, 20, 450, 70, "red_yellow18px");
  ...
  labelPowerSlider = new GLabel(this, 320, 470, 70, 20);
  ...
  labelBrakeSlider = new GLabel(this, 400, 470, 70, 20);
  ...
  csliderPower = new GCustomSlider(this, 390, 20, 450, 70, "blue18px");
  ...
  csliderPower.setLimits(50, 200, 30);
  ...
  btnStartExperiment = new GButton(this, 480, 220, 110, 60);
  ...
  buttonSave = new GButton(this, 480, 300, 110, 50);
  ...
  btnSetHigh = new GButton(this, 480, 20, 110, 40);
  btnSetHigh.setText("Set Fast 360");
  btnSetHigh.setTextBold();
  btnSetHigh.setLocalColorScheme(GCScheme.RED_SCHEME);
  btnSetHigh.addEventHandler(this, "btnSetHighClick");
  btnSetBaseline = new GButton(this, 480, 80, 110, 50);
  btnSetBaseline.setText("Set Slow 360");
  ...
  btnSet180 = new GButton(this, 480, 150, 110, 50);
  btnSet180.setText("Set 180 (Baseline)");
  ...
  optionDegrees180 = new GOption(this, 350, 510, 50, 40);
  ...
  optionDegrees360 = new GOption(this, 410, 510, 50, 40);
